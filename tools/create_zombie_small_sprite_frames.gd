...
const SOURCE_DIR := "res://assets/characters/enemies/zombie_small"
const OUTPUT_PATH := "res://resources/characters/enemies/zombie_small_sprite_frames.tres"
...
func _animation_name_from_path(path: String) -> String:
	...
	base_name = base_name.trim_prefix("zombie_small_")
