...
const SOURCE_DIR := "res://assets/equipment/weapons/pistol"
const OUTPUT_PATH := "res://resources/equipment/weapons/pistol/pistol_sprite_frames.tres"
...
func _initialize() -> void:
	...
	if error != OK:
		push_error("Failed to save Pistol SpriteFrames: %s" % error)
		quit(1)
		return
...
func _animation_names_from_path(path: String) -> PackedStringArray:
	...
	base_name = base_name.trim_prefix("pistol_")
